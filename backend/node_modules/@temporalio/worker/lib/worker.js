...
class Worker {
    ...
    async handleActivation(workflow, { activation, synthetic }) {
        try {
            ...
            const { externalStorage } = this.options.loadedDataConverter;
            await (0, internal_non_workflow_1.visit)(activation, internal_non_workflow_1.walkWorkflowActivation, (0, internal_non_workflow_1.extstoreInboundOptions)(externalStorage));
